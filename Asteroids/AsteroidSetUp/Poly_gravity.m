function [g_A, U, Wf] = Poly_gravity(r_A, Asteroid)
%% Function to calculate polyhedron gravity from Asteroid structure (from Get_Asteroid function)
%
...
Polyhedron = Asteroid.Polyhedron;
...
F = Polyhedron.Facets;
E = Polyhedron.Edges;
F_tilde = Polyhedron.F_tilde;
E_tilde = Polyhedron.E_tilde;
