...
% x0 = [2000; 0; 1500; 100; 0; -75; log(1905)];
% xf = [0; 0; 0; 0; 0; 0; log(1405)];
...
nodes = 50;
tf = 81;
CONSTANTS.theta_limit = 4*pi/180;
[tc,xc,uc,xdot,cpu_ps]=MSL_convex_transcription(x0,xf,nodes,tf);
...
m_spent = MAIN.x(7,1)-MAIN.x(7,end);
