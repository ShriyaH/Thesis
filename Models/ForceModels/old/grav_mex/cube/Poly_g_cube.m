function [g_A, g_I, g_B, Wf, U] = Poly_g_cube(r_A, q_BI, q_AI, rho, Vert, Fac, Edg, F_tilde, E_tilde)
...
g_I = quat_trans(conj_quat(q_AI),g_A,'vert');
g_B = quat_trans(q_BI,g_I,'vert');
