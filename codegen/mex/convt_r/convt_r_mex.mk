START_DIR = H:\My Documents\GitHub\Thesis\Thesis

MATLAB_ROOT = C:\PROGRA~1\MATLAB\R2016b
MAKEFILE = convt_r_mex.mk

include convt_r_mex.mki


SRC_FILES =  \
	convt_r_data.c \
	convt_r_initialize.c \
	convt_r_terminate.c \
	convt_r.c \
	conj_quat.c \
	cross_quat.c \
	Q2DCM.c \
	mpower.c \
	_coder_convt_r_info.c \
	_coder_convt_r_api.c \
	_coder_convt_r_mex.c

MEX_FILE_NAME_WO_EXT = convt_r_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\convt_r"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\convt_r/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
