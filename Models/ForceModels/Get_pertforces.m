...
if Switch.GG
    ...
    for i = 1:length(m_pm)
        ...
        if Switch.poly_grav == 1
            [g_pm_A(:,i)] = Poly_g(r_pm_A(:,i),Asteroid.rho,Asteroid.Polyhedron.Vertices,Asteroid.Polyhedron.Facets,Asteroid.Polyhedron.Edges,Asteroid.Polyhedron.F_tilde,Asteroid.Polyhedron.E_tilde);
